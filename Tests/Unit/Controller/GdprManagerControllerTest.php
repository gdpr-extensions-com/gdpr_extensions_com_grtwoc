...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComGrtwoc\Controller\GdprManagerController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\GdprExtensionsCom\GdprExtensionsComGrtwoc\Controller\GdprManagerController::class))
    ...
    public function listActionFetchesAllGdprManagersFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $gdprManagerRepository = $this->getMockBuilder(\GdprExtensionsCom\GdprExtensionsComGrtwoc\Domain\Repository\GdprManagerRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $gdprManager = new \GdprExtensionsCom\GdprExtensionsComGrtwoc\Domain\Model\GdprManager();
