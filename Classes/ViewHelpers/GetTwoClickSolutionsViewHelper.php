...
namespace GdprExtensionsCom\GdprExtensionsComGrtwoc\ViewHelpers;

use GdprExtensionsCom\GdprExtensionsComGrtwoc\Domain\Repository\GdprManagerRepository;
    ...
    public function render()
    {
        ...
        $gdprDellQb
            ...
            $twoClickSolutionsWithoutReviews = array_filter($twoClickSolutions, function ($ext) {
                ...
                return stripos($ext, 'gdpr_extensions_com_gr') === false;
            });
